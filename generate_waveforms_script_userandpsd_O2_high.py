...
wfd.load_event('data/events/GW150914/', randpsd=True, randpsd_events=['GW170823'])

wfd.importance_sampling = 'uniform_distance'

wfd.prior['distance'] = [100.0, 6000.0]
...
wfd.save('waveforms/O2_high_randpsd')
wfd.save_train('waveforms/O2_high_randpsd')
wfd.save_noisy_test_data('waveforms/O2_high_randpsd')
